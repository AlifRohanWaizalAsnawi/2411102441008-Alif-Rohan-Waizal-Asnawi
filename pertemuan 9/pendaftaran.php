    ...
    <form action="proses.php" method="POST">
        ...
        <div class="date-input">
            <select name="tgl_lahir_tgl" required>
                ...
                <?php
                // Tgl: Menampilkan angka 1 sampai 31
                for ($i = 1; $i <= 31; $i++) {
            ...
            <select name="tgl_lahir_bln" required>
                ...
                <?php
                // Bln: Menampilkan angka (untuk value) dan nama bulan (untuk display)
                $bulan = ["01" => "Januari", "02" => "Februari", "03" => "Maret", "04" => "April", "05" => "Mei", "06" => "Juni", "07" => "Juli", "08" => "Agustus", "09" => "September", "10" => "Oktober", "11" => "November", "12" => "Desember"];
                foreach ($bulan as $nomor => $nama_bln) {
                    echo "<option value=\"$nomor\">$nomor - $nama_bln</option>"; // Menampilkan nomor dan nama bulan
                }
                ?>
            </select>
            ...
            <select name="tgl_lahir_thn" required>
                ...
                <?php
                // Thn: Menampilkan angka dari 2005 sampai 1980
                for ($i = 2005; $i >= 1980; $i--) {
                    echo "<option value=\"$i\">$i</option>";
                }
                ?>
